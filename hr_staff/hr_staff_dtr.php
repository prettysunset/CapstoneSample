...
<script>
  // attach confirm to top logout like hr_staff_ojts.php
  (function(){
  ...
  <script>
    ...
    (function(){
      ...
      // inline styles to ensure consistent overlay behavior even if page lacks .overlay CSS
  ...
  <script>
    ...
    (function(){
      ...
      // inline styles mirror calendar overlay for consistency
