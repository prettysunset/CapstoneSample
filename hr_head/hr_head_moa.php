...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && (isset($_POST['action']) && $_POST['action'] === 'add_moa')) {
    ...
    if ($ok) {
        ...
        // HR head + HR staff (exclude uploader)
        ...
        // OJTs whose students.college matches this school (case-insensitive trim)
        ...
        // Office heads for offices that have OJTs with that school
        ...
        // exclude uploader and clean list
...
<script>
  // Calendar modal open/close handlers (inline-styled overlay)
  (function(){
...
<script>
  ...
  (function(){
    ...
    settingsOverlay.style.background = 'rgba(16,24,40,0.28)';
